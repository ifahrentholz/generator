...
var structure = require("./mock/structure2.json");
...
var checkDirectory = function(directory) {
  try {
    fso.statSync(directory);
    return true;
  } catch(e) {
    return false;
  }
...
program
  ...
  .action(function(appName) {
    if(checkDirectory(appName)) {
      return console.log(logRed("Can't proceed because the directory " + appName + " already exists."));
    }
    return new looper(appName, structure);
  });
